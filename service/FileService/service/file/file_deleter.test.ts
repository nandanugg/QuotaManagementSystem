...
t.test('should call DeleteFileById with correct user and handle correctly', async () => {
    const DeleteFileByIdStub = sinon.stub(deps, 'DeleteFileById').resolves(null);
    ...
    const srv = DeleteFileById({...deps, DeleteFileById: DeleteFileByIdStub, GetFileById: GetFileByIdStub});
